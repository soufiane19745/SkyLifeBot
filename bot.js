...
client.on('ready', function(){
    var ms = 60000 ;
    var setGame = ['shelp | By AK','Type shelp|By AK'];
    var i = -1;
    var j = 0;
...
message.channel.send(":postbox: **لقد قمت بإرسال رسالت المساعده في الخاص**")
    let pages = [`**
        ***__General orders__***
**
